...
<body>
    <%
        ...
        DaoPostagem.editarPostagem(Integer.parseInt(idPostagem), texto);
        out.write("<script>document.location.href = 'http://localhost:8080/EditarPost.jsp?id="+idPostagem+"'</script");
    %>
</body>
</html>
